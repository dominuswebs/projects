package quizCard.src;

// javac -d bin src/QuizCardBuilder.java src/QuizCard.java
// java -cp bin quizCard.src.QuizCardBuilder 
...
public class QuizCardBuilder {
    ...
    private void saveCard() {
        ...
        String currentDir = System.getProperty("user.dir"); // set the default folder to the current working directory
        JFileChooser fileSave = new JFileChooser(currentDir);
    ...
    private void saveFile(File file) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))){
            ...
            // no longer needed. Try-with-resources means that the compiler makes a finally block for us. See autocloseable classes
            //writer.close();
        } catch (IOException e) {
